...
class DepartmentController extends Controller
{
    ...
    {
        $year = Departments::findorfail($id);
        $year->delete();

        return redirect()->route('departments.index')->throwResponse('Timetable entry deleted successfully', 200);
    }
}
